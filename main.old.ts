...
//   console.log('socket port: 4000');
// });
// app.listen('4001', () => {
//   console.log('express port 4001'); // express server za post i get requestove
// })
...
//   socket.on('moveBrush', (e: any) => {//soket koji prosledjuje koordinate crteza svima u sobi
//     // LoggerSingleton.logs.colors.push(e.color)
//     socket.to(rooms[socket.id]).emit('moveBrush', e)//event ime je draw
//   });
